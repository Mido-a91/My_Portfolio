...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            with open('My_model_withBack_Elim','rb') as model_file, open('My_scaler_withBack_Elim', 'rb') as scaler_file:
        ...
        def load_and_clean_data(self, data_file):
            ...
            df = df.drop(['Body Mass Index','Daily Work Load Average','Distance to Work'],axis=1)
